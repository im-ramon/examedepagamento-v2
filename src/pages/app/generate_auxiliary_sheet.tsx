                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <FormBlockContainer>
                        ...
                        <FormItem labelText='Data do contracheque' supportText='Qual a data do contracheque?'>
                            <input {...register('dataReferencia', { required: true })} name="data_contracheque" type="date" defaultValue="2023-01-01" className={styleInputSelect} />
                        </FormItem>
                    ...
                    <FormBlockContainer>
                        ...
                        <FormItem labelText='Adicional de Férias' supportText='O examinado irá gozar Férias?' helpText='Valor correspondente a 1/3 (um terço) da remuneração do mês de início das férias (no caso dos PTTC, 1/3 do Adicional PTTC), pago antecipadamente.'>
                            <div className='flex items-center justify-center w-full py-1'>
                                <span className='text-sm mx-2'>Não</span>
                                <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        <FormItem labelText='Dependentes para imposto de renda' supportText='Possui quantos dependentes para fins de imposto de renda?' helpText='Neste campo deve ser informado a quantidade de dependentes para fins de dedução no imposto de renda. Deve-se tomar como base o Decreto nº 3.000, de 26 de março de 1999.'>
                        ...
                        <FormItem labelText='Auxílio Alimentação - Tipo "C"' supportText='O examinado receberá Auxílio Alimentação - Tipo "C"?' helpText='Este auxílio é devido aos Cabos e Soldados, da ativa, quando entram de férias. São pagas 30 etapas, no valor de R$ 9,00 cada.'>
                            <div className='flex items-center justify-center w-full py-1'>
                                <span className='text-sm mx-2'>Não</span>
                                <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        <FormItem labelText='Pensão Militar' supportText='O examinado contribui para a Pensão Militar?' helpText='É o desconto obrigatório incidente sobre a remuneração do militar para custeio das futuras pensões destinadas aos seus beneficiários. São contribuintes obrigatórios da pensão militar, mediante desconto mensal em folha de pagamento, os militares das Forças Armadas e os seus pensionistas, ou seja, TODOS CONTRIBUEM. O desconto da pensão militar tem alíquota de 10,5% (dez e meio por cento), conforme previsto na Lei nº 13.954, de 16 de dezembro de 2019.'>
                            <div className='flex flex-1 items-center justify-center w-full py-1'>
                                <span className='text-sm mx-2'>Não</span>
                                <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        <FormItem labelText='FuSEx 3%' supportText='Contribui para o FuSEx?' helpText='O desconto de FuSEx é destinado à manutenção da assistência médico-hospitalar do Exército Brasileiro. Alguns militares/ pensionsitas não contribuem por meio desse desconto, são eles: - Os soldades em serviço militar obrigatório - Os ex-combatentes - Os pensionistas especiais de ex-combatentes - Os militares que são dependentes de outros militares (cônjuge, filho etc) - Algumas pensionistas filhas, implantadas após a Lei nº 13.954/2019'>
                            <div className='flex items-center justify-center w-full py-1'>
                                <span className='text-sm mx-2'>Não</span>
                                <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        <FormItem labelText='Desconto de dependentes no FuSEx' supportText='Qual percentual de desconto de dependentes no FuSEx?' helpText='Deve ser analisado a quantidade de dependentes que o militar/ pensionista possui cadastrado como dependentes no FuSEx. Para 1 (um) dependente cadastrado, exceto o cônjuge ou companheira(o), o desconto será de 0,4% sobre o bruto. Para 2 (dois) ou mais dependentes cadastrados,   exceto o cônjuge ou companheira(o),  o desconto será de 0,5% sobre o bruto, não ultrapassando essa alíquota.'>
